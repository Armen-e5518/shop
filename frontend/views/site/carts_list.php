            ...
            <div class="row">
               ...
               <?php if (!empty($products)): ?>
                  <?php foreach ($products as $item):
                     $product = \common\models\Products::findOne($item['id']);
                     $img = \common\models\ProductImages::GetOan($item['id'])
                     ?>
                     <div class="col-md-4 col-xs-6">
                        <div class="product">
                           <div class="product-img">
                              <stong class="cart-count-p"><?=$item['count']?> X</stong>
                           ...
                           <div class="add-to-cart">
                              <button class="add-to-cart-btn remove_cart" data-id="<?= $product->id ?>"><i class="fa fa-shopping-cart"></i> Remove cart</button>
                           </div>
                        </div>
                     </div>
                  <?php endforeach; ?>
