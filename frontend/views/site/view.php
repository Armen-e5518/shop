            ...
            <div class="col-md-5">
                <div class="product-details">
                    ...
                    <ul class="product-links">
                        <li>Category:</li>
                        <li>
                            <a href="/site/store?ProductsSearchStore%5Bcategories%5D%5B%5D=<?= $product->category_id ?>"><?= \common\models\Categories::GetName($product->category_id) ?></a>
                        </li>
                    </ul>

                    <ul class="product-links">
                        <li>Share:</li>
                        <li><a id="fb" target="_blank" href="#"><i class="fa fa-facebook"></i></a></li>
                    </ul>
                    <?= \ymaker\social\share\widgets\SocialShare::widget([
                        'configurator' => 'socialShare',
                        'containerOptions' => ['tag' => 'ul', 'class' => 'product-links-delete'],
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div id="review-form">
                                        ...
                                        <input class="hide" name="ProductComments[product_id]" type="text"
                                               value="<?= $product->id ?>">
                                        <input required="required" class="input" name="ProductComments[name]"
                                               type="text" placeholder="Your Name">
                                        <input required="required" class="input" name="ProductComments[email]"
                                               type="email" placeholder="Your Email">
                                        <textarea required="required" class="input" name="ProductComments[comment]"
                                                  placeholder="Your Review"></textarea>
                                        <div class="input-rating">
                                            <span>Your Rating: </span>
                                            <div class="stars">
                                                <input id="star5" name="ProductComments[star]" value="5"
                                                       type="radio"><label for="star5"></label>
                                                <input id="star4" name="ProductComments[star]" value="4"
                                                       type="radio"><label for="star4"></label>
                                                <input id="star3" name="ProductComments[star]" value="3"
                                                       type="radio"><label for="star3"></label>
                                                <input id="star2" name="ProductComments[star]" value="2"
                                                       type="radio"><label for="star2"></label>
                                                <input id="star1" name="ProductComments[star]" value="1"
